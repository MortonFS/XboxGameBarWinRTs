...
void Widget1::canvasSwapChainPanel_Loaded(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	...
	sdk::window_width = (float)Window::Current->CoreWindow->Bounds.Width;
	sdk::window_height = (float)Window::Current->CoreWindow->Bounds.Height;
